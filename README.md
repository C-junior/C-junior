...
## Selected highlights
- Improved Lighthouse performance score for cj-portfolio-dev by [X%] after targeted optimizations. (replace [X%] with real metric)
- Reduced CodeNews frontend client bundle size by [Y%] using code-splitting and tree-shaking. (replace [Y%])
- Resolved [N] accessibility issues in HydrocultivoAI and raised WCAG conformance to AA. (replace [N])

(Replace bracketed placeholders with your real metrics and brief context.)

---

## Work & availability
Open to frontend roles, freelance/contract work, and meaningful collaborations. I prefer working closely with product and design teams to ship polished, usable interfaces.

---

## Contact
- Email: [ti.juniorc@gmail.com](mailto:ti.juniorc@gmail.com)
- LinkedIn: https://www.linkedin.com/in/juniorcristovao
- Portfolio (source): https://github.com/C-junior/cj-portfolio-dev
- GitHub: https://github.com/C-junior
...
[![Dev.to](https://img.shields.io/badge/DEV-@yourdevhandle-0a0a0a?style=for-the-badge&logo=dev.to)](https://dev.to/yourdevhandle)
[![Email](https://img.shields.io/badge/Email-ti.juniorc%40gmail.com-blue?style=for-the-badge&logo=gmail)](mailto:ti.juniorc@gmail.com)
